primitive I8 is SignedInteger[I8]
  ...
  fun box min(that: I8): I8 => if this < that then this else that end
...
primitive I16 is SignedInteger[I16]
  ...
  fun box min(that: I16): I16 => if this < that then this else that end
...
primitive I32 is SignedInteger[I32]
  ...
  fun box min(that: I32): I32 => if this < that then this else that end
...
primitive I64 is SignedInteger[I64]
  ...
  fun box min(that: I64): I64 => if this < that then this else that end
...
primitive I128 is SignedInteger[I128]
  ...
  fun box max(that: I128): I128 => if this > that then this else that end
  fun box min(that: I128): I128 => if this < that then this else that end
