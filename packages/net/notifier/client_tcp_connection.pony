...
actor ClientTCPConnection is
  ...
  [`ClientTCPConnectionNotify`](/net/notifier-ClientTCPConnectionNotify/).

  Wraps `TCPConnection` and `ClientLifecycleEventReceiver` into a single
  actor, forwarding lifecycle callbacks to the notifier you provide.
  This is the notifier-based alternative to implementing
  ...
  new create(auth: net.TCPConnectAuth,
  ...
  new ssl(auth: net.TCPConnectAuth,
    notify: ClientTCPConnectionNotify iso,
