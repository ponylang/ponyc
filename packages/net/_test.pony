...
actor \nodoc\ Main is TestList
  ...
  fun tag tests(test: PonyTest) =>
    ...
    test(_TestUDPSendOk)
    test(_TestUDPSendWouldBlock)
    test(_TestUDPSendError)
    test(_TestUDPSendNotOpen)
    test(_TestUDPRecvData)
    test(_TestUDPCloseFromReceived)
    test(_TestUDPRecvError)
    test(_TestUDPYieldReading)
    test(_TestUDPBudget)
    ...
    test(_TestSendOk)
    test(_TestSendMultipleTokenOrder)
    test(_TestSendOnClosed)
    test(_TestSendError)
    test(_TestSendFailedAfterClosed)
    test(_TestRecvError)
    test(_TestRecvRetry)
    test(_TestRecvData)
    test(_TestRecvFramed)
    test(_TestMuteFromRecv)
    ...
    test(_TestListenFailure)
    test(_TestAccept)
    test(_TestConnectionLimit)
    ...
    test(_TestMockReadableEventWriteRecovery)
