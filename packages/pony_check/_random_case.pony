...
actor \nodoc\ Main is TestList
  ...
  fun tag tests(test: PonyTest) =>
    ...
    test(_FailingStatefulPropertyTest)
    test(_StatefulUnitTestAdapterTest)
    test(_StatefulMaxStepsZeroTest)
    test(_AsyncStatefulPropertyTest)
    test(_AsyncStatefulFailingPropertyTest)
    test(_StatefulStepAlwaysErrorsTest)
    test(_StatefulFinalCheckFailureTest)
    test(_StatefulShrinkQualityTest)
