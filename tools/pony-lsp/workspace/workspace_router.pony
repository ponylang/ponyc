...
class WorkspaceRouter
  """
  Routes document URIs to the appropriate workspace
  manager.
  """
  ...
  new ref create() =>
    workspaces =
      Map[String, WorkspaceManager].create()
    min_workspace_path_len = USize.max_value()

  fun find_workspace(
    file_uri: String): (WorkspaceManager | None)
  =>
