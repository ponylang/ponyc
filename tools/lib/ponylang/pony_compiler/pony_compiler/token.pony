...
primitive TokenIds
  ...
  fun tk_bool_true(): I32 => 157
  fun tk_bool_false(): I32 => 158
  ...
  fun tk_typeparams(): I32 => 164
  fun tk_typeparam(): I32 => 165
  fun tk_params(): I32 => 166
  fun tk_param(): I32 => 167
  fun tk_typeargs(): I32 => 168
  fun tk_valueformalparam(): I32 => 169
  fun tk_valueformalarg(): I32 => 170
  fun tk_positionalargs(): I32 => 171
  fun tk_namedargs(): I32 => 172
  fun tk_namedarg(): I32 => 173
  fun tk_updatearg(): I32 => 174
  fun tk_lambdacaptures(): I32 => 175
  fun tk_lambdacapture(): I32 => 176

  fun tk_seq(): I32 => 177
  fun tk_qualify(): I32 => 178
  fun tk_call(): I32 => 179
  fun tk_tuple(): I32 => 180
  fun tk_array(): I32 => 181
  fun tk_cases(): I32 => 182
  fun tk_case(): I32 => 183
  fun tk_match_capture(): I32 => 184
  fun tk_match_dontcare(): I32 => 185

  fun tk_reference(): I32 => 186
  fun tk_packageref(): I32 => 187
  fun tk_typeref(): I32 => 188
  fun tk_typeparamref(): I32 => 189
  fun tk_typealiasref(): I32 => 190
  fun tk_newref(): I32 => 191
  fun tk_newberef(): I32 => 192
  fun tk_beref(): I32 => 193
  fun tk_funref(): I32 => 194
  fun tk_fvarref(): I32 => 195
  fun tk_fletref(): I32 => 196
  fun tk_embedref(): I32 => 197
  fun tk_tupleelemref(): I32 => 198
  fun tk_varref(): I32 => 199
  fun tk_letref(): I32 => 200
  fun tk_paramref(): I32 => 201
  fun tk_dontcareref(): I32 => 202
  fun tk_newapp(): I32 => 203
  fun tk_beapp(): I32 => 204
  fun tk_funapp(): I32 => 205
  fun tk_bechain(): I32 => 206
  fun tk_funchain(): I32 => 207

  fun tk_annotation(): I32 => 208
  ...
  fun string(token_id: TokenId): String val =>
    ...
    | 160 => "TK_ERRORTYPE"
    | 161 => "TK_LITERAL"
    | 162 => "TK_LITERALBRANCH"
    | 163 => "TK_OPERATORLITERAL"
    | 164 => "TK_TYPEPARAMS"
    | 165 => "TK_TYPEPARAM"
    | 166 => "TK_PARAMS"
    | 167 => "TK_PARAM"
    | 168 => "TK_TYPEARGS"
    | 169 => "TK_VALUEFORMALPARAM"
    | 170 => "TK_VALUEFORMALARG"
    | 171 => "TK_POSITIONALARGS"
    | 172 => "TK_NAMEDARGS"
    | 173 => "TK_NAMEDARG"
    | 174 => "TK_UPDATEARG"
    | 175 => "TK_LAMBDACAPTURES"
    | 176 => "TK_LAMBDACAPTURE"
    | 177 => "TK_SEQ"
    | 178 => "TK_QUALIFY"
    | 179 => "TK_CALL"
    | 180 => "TK_TUPLE"
    ...
    | 182 => "TK_CASES"
    | 183 => "TK_CASE"
    | 184 => "TK_MATCH_CAPTURE"
    | 185 => "TK_MATCH_DONTCARE"
    | 186 => "TK_REFERENCE"
    | 187 => "TK_PACKAGEREF"
    | 188 => "TK_TYPEREF"
    | 189 => "TK_TYPEPARAMREF"
