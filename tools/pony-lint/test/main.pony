...
actor \nodoc\ Main is TestList
  ...
  fun tag tests(test: PonyTest) =>
    ...
    test(_TestLineLengthStringNoSpacesFlagged)
    ...
    test(_TestLineLengthMultipleStringsFlagged)
    test(_TestLineLengthEscapedQuotesFlagged)
    test(_TestLineLengthTripleQuoteLineNoExempt)
    test(_TestLineLengthStringUTF8Flagged)
    test(_TestLineLengthStringFlaggedWhenDeepProperty)
    ...
    test(_TestLineLengthASTDocstringQuotedIdExempt)
    test(_TestLineLengthASTDocstringURLExempt)
    test(_TestLineLengthASTMixedDocstringAndLiteral)
    test(_TestLineLengthWordExemptCommentURL)
    test(_TestLineLengthWordFlaggedCommentURL)
    test(_TestLineLengthWordThirdWordCrossingFlagged)
    test(_TestLineLengthWordExemptLongWord)
    test(_TestLineLengthWordNotExemptShortWords)
    test(_TestLineLengthWordAtCol80Exempt)
    test(_TestLineLengthWordAtCol81NotExempt)
    test(_TestLineLengthWordExemptProperty)
    test(_TestLineLengthWordExemptUTF8)
