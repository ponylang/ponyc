...
The spurious errors no longer appear. You'll still see the real syntax error,
but the compiler won't pile on with bogus errors from other files in the same
package.
