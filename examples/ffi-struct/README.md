...
```console
gcc -shared -Wall -Wextra -g -o libffi-struct.so c-src/struct.c
```

### MacOS

```console
clang -fPIC -Wall -Wextra -g -c -o struct.o c-src/struct.c
...
```console
mkdir lib
cl.exe /c /Fo"lib\ffi-struct.obj" c-src\struct.c
