...
actor Stat
  ...
  be print_actor_stats(env: Env) =>
    ...
    var agc = ActorStats.gc_cpu(ActorStatsAuth(env.root))
    ...
    env.out.print("Actor stats:"
      ...
      + "\n  app cpu: " + aac.string()
      + "\n  garbage collection cpu: " + agc.string()
  ...
  be print_scheduler_stats(env: Env) =>
    ...
    var agc = SchedulerStats.actor_gc_cpu(SchedulerStatsAuth(env.root))
