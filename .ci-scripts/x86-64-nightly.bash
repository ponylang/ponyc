...
cmake --preset "${ARCH}-release" -DPONY_CPU="${ARCH}" -DPONY_INSTALL_SYMLINKS=OFF \
  -DPONYC_VERSION="${PONY_VERSION}"
cmake --build --preset "${ARCH}-release"
cmake --install "build/build_${ARCH}-release" --prefix "${BUILD_PREFIX}"
