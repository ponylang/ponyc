const char* t_bool =
  "(uniontype"
  "  (nominal{dataref True} x (id True) x val x)"
  "  (nominal{dataref False} x (id False) x val x))";

const char* t_u_lit =
  "(nominal{dataref UIntLiteral} x (id UIntLiteral) x val x)";

const char* t_s_lit =
  "(nominal{dataref SIntLiteral} x (id SIntLiteral) x val x)";

const char* t_f_lit =
  "(nominal{dataref FloatLiteral} x (id FloatLiteral) x val x)";

const char* t_none =   "(nominal{dataref None} x (id None) x val x)";
const char* t_true =   "(nominal{dataref True} x (id True) x val x)";
const char* t_false =  "(nominal{dataref False} x (id False) x val x)";
...
const char* t_structural =
  ...
  "      (nominal{dataref None} x (id None) x val x) x x)) val x)";
...
// Builtin definitions
"    (data{def None} (id None) x val x x)"
"    (data{def True} (id True) x val x x)"
"    (data{def False} (id False) x val x x)"
"    (type{def Bool} (id Bool)"
"      (uniontype{def BoolUse}"
"        (nominal{dataref True} x (id True) x val x)"
"        (nominal{dataref False} x (id False) x val x)))"
"    (data{def I8} (id I8) x val x x)"
"    (data{def I16} (id I16) x val x x)"
"    (data{def I32} (id I32) x val x x)"
"    (data{def I64} (id I64) x val x x)"
"    (data{def I128} (id I128) x val x x)"
"    (data{def U8} (id U8) x val x x)"
"    (data{def U16} (id U16) x val x x)"
"    (data{def U32} (id U32) x val x x)"
"    (data{def U64} (id U64) x val x x)"
"    (data{def U128} (id U128) x val x x)"
"    (data{def F16} (id F16) x val x x)"
"    (data{def F32} (id F32) x val x x)"
"    (data{def F64} (id F64) x val x x)"
"    (data{def SIntLiteral} (id SIntLiteral) x val x x)"
"    (data{def UIntLiteral} (id UIntLiteral) x val x x)"
"    (data{def FloatLiteral} (id FloatLiteral) x val x x)"
"    (class{def String} (id String) x val x x)"
"    (type{def SInt} (id SInt)"
"      (uniontype"
"        (nominal x (id SIntLiteral) x val x)"
"        (nominal x (id I8) x val x)"
"        (nominal x (id I16) x val x)"
"        (nominal x (id I32) x val x)"
"        (nominal x (id I64) x val x)"
"        (nominal x (id I128) x val x)))"
"    (type{def UInt} (id UInt)"
"      (uniontype"
"        (nominal x (id UIntLiteral) x val x)"
"        (nominal x (id U8) x val x)"
"        (nominal x (id U16) x val x)"
"        (nominal x (id U32) x val x)"
"        (nominal x (id U64) x val x)"
"        (nominal x (id U128) x val x)))"
...
"          (nominal{dataref None} x (id None) x val x) x"
