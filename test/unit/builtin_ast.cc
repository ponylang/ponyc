...
"    (primitive{def True} (id True) x val x x)"
"    (primitive{def False} (id False) x val x x)"
...
"    (primitive{def UIntLiteral} (id UIntLiteral) x val x x)"
"    (primitive{def FloatLiteral} (id FloatLiteral) x val x x)"
