// Regression test for expr_repeat accumulator leak (ponylang/ponyc#5210).
//
// expr_repeat reads the loop's type (which may be non-NULL from prior
// break expressions) and accumulates body and else-clause types via
