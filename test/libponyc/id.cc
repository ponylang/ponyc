...
TEST_F(IdTest, DoubleUnderscore)
{
  ...
  DO(test_id("foo__bar", true, ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
  DO(test_id("__foobar", false, ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
  DO(test_id("__foo__bar", false, ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
  ...
  DO(test_id("foo__bar", true,
    ALLOW_LEADING_UNDERSCORE | ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));

  DO(test_id("__foobar", true,
    ALLOW_LEADING_UNDERSCORE | ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));

  DO(test_id("__foo__bar", true,
    ALLOW_LEADING_UNDERSCORE | ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
}
...
TEST_F(IdTest, TripleUnderscore)
{
  ...
  DO(test_id("foo___bar", true, ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
  DO(test_id("___foobar", false, ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));

  DO(test_id("___foo___bar", false,
    ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
  ...
  DO(test_id("foo___bar", true,
    ALLOW_LEADING_UNDERSCORE | ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));

  DO(test_id("___foobar", true,
    ALLOW_LEADING_UNDERSCORE | ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));

  DO(test_id("___foo___bar", true,
    ALLOW_LEADING_UNDERSCORE | ALLOW_UNDERSCORE | ALLOW_DOUBLE_UNDERSCORE));
}
...
TEST_F(IdTest, TrailingUnderscore)
{
  ...
  DO(test_id("foobar_'", false, ALLOW_UNDERSCORE));
  DO(test_id("foo_bar", true, ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE));
  DO(test_id("foobar_", true, ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE));
  DO(test_id("foo_bar_", true, ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE));
  DO(test_id("foobar_'", false, ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE));

  DO(test_id("foo_bar", true,
    ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE | ALLOW_TICK));

  DO(test_id("foobar_", true,
    ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE | ALLOW_TICK));

  DO(test_id("foo_bar_", true,
    ALLOW_UNDERSCORE | ALLOW_TRAILING_UNDERSCORE | ALLOW_TICK));
