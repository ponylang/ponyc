...
const char* t_none =   "(nominal{dataref None} x (id None) x val x x)";
const char* t_bool =   "(nominal{dataref Bool} x (id Bool) x val x x)";
const char* t_u8 =     "(nominal{dataref U8} x (id U8) x val x x)";
const char* t_u16 =    "(nominal{dataref U16} x (id U16) x val x x)";
const char* t_u32 =    "(nominal{dataref U32} x (id U32) x val x x)";
const char* t_u64 =    "(nominal{dataref U64} x (id U64) x val x x)";
const char* t_u128 =   "(nominal{dataref U128} x (id U128) x val x x)";
const char* t_i8 =     "(nominal{dataref I8} x (id I8) x val x x)";
const char* t_i16 =    "(nominal{dataref I16} x (id I16) x val x x)";
const char* t_i32 =    "(nominal{dataref I32} x (id I32) x val x x)";
const char* t_i64 =    "(nominal{dataref I64} x (id I64) x val x x)";
const char* t_i128 =   "(nominal{dataref I128} x (id I128) x val x x)";
const char* t_f32 =    "(nominal{dataref F32} x (id F32) x val x x)";
const char* t_f64 =    "(nominal{dataref F64} x (id F64) x val x x)";
const char* t_string = "(nominal{dataref String} x (id String) x val x x)";
const char* t_t1 =     "(nominal{dataref T1} x (id T1) x val x (id P1))";
const char* t_t2 =     "(nominal{dataref T2} x (id T2) x val x (id P1))";
const char* t_t3 =     "(nominal{dataref T3} x (id T3) x val x (id P1))";
const char* t_foo =    "(nominal{dataref Foo} x (id Foo) x val x (id P1))";
const char* t_bar =    "(nominal{dataref Bar} x (id Bar) x val x (id P1))";
const char* t_iface =  "(nominal{dataref Iface} x (id Bar) x val x (id P1))";
...
"      (types (nominal{dataref T3} x (id T3) x ref x x))\n"
"      members)\n"
...
"      (types (nominal{dataref T1} x (id T1) x ref x x))\n"
"      (members\n"
"        (fun{scope}{def f} box (id f) x x\n"
"          (nominal{dataref None} x (id None) x tag x x) x\n"
