...
TEST_F(BadPonyTest, Issue4160)
{
  add_package("broken", "class Broken\n  new create() = \n    None");
  const char* src =
    "use \"broken\"\n"
    "actor Main\n"
    "  new create(env: Env) =>\n"
  ...
  TEST_ERRORS_2(src,
    "syntax error: unexpected token = after type, interface, trait, primitive, class or actor definition",
