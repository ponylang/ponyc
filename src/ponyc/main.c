...
static void usage()
{
  printf("%s\n%s\n%s\n%s\n%s\n%s", // for complying with -Woverlength-strings
    ...
    "  --ponyqkcycles  Minimum number of kilocycles of quiescence before a\n"
    "                  scheduler thread will attempt to stop the runtime.\n"
    "                  Increasing this number can improve performance of the\n"
    "                  runtime, at the cost of delaying program termination.\n"
    "                  For high performance in long-running applications,\n"
    "                  values near 10000000 may be appropriate.\n"
    "                  Defaults to 0.\n"
