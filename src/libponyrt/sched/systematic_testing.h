...
#define SYSTEMATIC_TESTING_START(SCHEDULERS, PINNED_ACTOR_THREAD, PINNED_ACTOR_SLEEP_OBJECT) ponyint_systematic_testing_start(SCHEDULERS, PINNED_ACTOR_THREAD, PINNED_ACTOR_SLEEP_OBJECT)
...
#define SYSTEMATIC_TESTING_START(SCHEDULERS, PINNED_ACTOR_THREAD, PINNED_ACTOR_SLEEP_OBJECT)
