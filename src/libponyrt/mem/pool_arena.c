...
// reuse instead of returning to the operating system. Two arenas' worth on
// 64-bit, covering a single block-class cycle and one oversized mapping
// up to 16 MiB. Mirrored by the PoolArena tests' TEST_LARGE_RETAIN_DEFAULT;
// change both together.
#define POOL_LARGE_RETAIN (16 * 1024 * 1024)
...
#define RUNG3_LARGE_RETAIN (16 * 1024 * 1024)
