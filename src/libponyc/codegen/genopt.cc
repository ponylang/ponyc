...
// This optimization pass is not safe...
//
// It tries to remove calls to `pony_realloc` by making the original pointer
// bigger to match the later realloc size, but it doesn't do any analysis
