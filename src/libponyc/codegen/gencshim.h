...
// Write C source for a by-value FFI thunk into buf. The thunk wraps
// f_name, accepting Pony-style pointers and dereferencing them for the
// real C call. Returns false and reports through errors on unsupported
// field types.
...
// Compile C source to an LLVM module using the embedded clang, sharing
// the LLVMContext of c. Returns NULL on failure; errors are reported
// through opt->check.errors.
