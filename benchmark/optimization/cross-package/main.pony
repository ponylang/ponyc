"""
Cross-package HeapToStack promotion.
...
function importing or full LTO module merging. A single-module build inlines
everything within one module, so this benchmark establishes the baseline that
per-package builds must match.

200M Point allocations per run. Promoted allocations are orders of magnitude
faster than heap-allocated ones.
"""
use "lib"
