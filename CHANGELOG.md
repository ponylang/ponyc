...
- Fix TCP backpressure stalls on BSDs ([PR #6037](https://github.com/ponylang/ponyc/pull/6037))
...
- Fix false "declaration appears after use" error with trait default method bodies ([PR #5857](https://github.com/ponylang/ponyc/pull/5857))
...
- Fix wrapping division of signed minimum value by -1 ([PR #5918](https://github.com/ponylang/ponyc/pull/5918))
...
- Fix segfault in programs with finalizers compiled with --runtimebc ([PR #5975](https://github.com/ponylang/ponyc/pull/5975))
...
- Rename PonyCheck generator range parameters from min/max to from/to ([PR #5979](https://github.com/ponylang/ponyc/pull/5979))
